...
int query_NPOT_capability( void )
{
	...
	if( has_NPOT_capability == SOIL_CAPABILITY_UNKNOWN )
	{
		...
		if(
			(0 == gl_have_extension("GL_ARB_texture_non_power_of_two") )
			)
		{
...
int query_tex_rectangle_capability( void )
{
	...
	if( has_tex_rectangle_capability == SOIL_CAPABILITY_UNKNOWN )
	{
		/*	we haven't yet checked for the capability, do so	*/
		if(
			(0 == gl_have_extension( "GL_ARB_texture_rectangle"))
		&&
			(0 == gl_have_extension("GL_EXT_texture_rectangle"))
		&&
			(0 == gl_have_extension("GL_NV_texture_rectangle"))
			)
		{
			/*	not there, flag the failure	*/
...
int query_cubemap_capability( void )
{
	...
	if( has_cubemap_capability == SOIL_CAPABILITY_UNKNOWN )
	{
		/*	we haven't yet checked for the capability, do so	*/
		if(
			(0 == gl_have_extension("GL_ARB_texture_cube_map"))
		&&
			(0 == gl_have_extension("GL_EXT_texture_cube_map"))
			)
		{
			/*	not there, flag the failure	*/
...
int query_DXT_capability( void )
{
	...
	{
		/*	we haven't yet checked for the capability, do so	*/
		if (0 == gl_have_extension("GL_EXT_texture_compression_s3tc"))
		{
			/*	not there, flag the failure	*/
